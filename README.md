...
### Zenodo auto-archive on every GitHub release

1. Create a Zenodo account and connect it to GitHub.
2. In Zenodo, enable the `yunusserhat/sppt` repository.
3. In GitHub, create a tagged release (for example `v0.1.0`).
4. Zenodo will automatically archive the release and mint/update a DOI.
5. Replace the DOI badge at the top of this README with the real Zenodo DOI badge URL.
